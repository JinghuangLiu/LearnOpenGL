...
public:
    ...
    virtual void LoopOnce(XSMatrix &proj, XSMatrix &cam, XSMatrix &parent);
    ...
    void addChild(std::shared_ptr<Object3D> childObject3D);
...
protected:
    ...
    XSVector3 mPosition;//Get Set
    XSVector3 mRotation; //Get Set
    XSVector3 mScale; //Get Set
};
